    ...
    return (
      <section className="min-h-screen flex items-center justify-center pt-14">
        <div className="text-center px-5">
          ...
          <p className="text-sm text-white mb-6">You need to be logged in to access My Arena.</p>
  ...
  return (
    <section className="min-h-screen pt-14">
      <div className="container-main py-16">
        <div className="mb-12">
          <p className="text-xs text-white uppercase tracking-[0.2em] mb-3">My Arena</p>
          <h1 className="text-2xl font-bold text-white mb-2">
            Welcome, {user.full_name || "Champion"}
          </h1>
          <p className="text-sm text-white">{user.email}</p>
          {user.is_demo && (
            <p className="text-xs text-white mt-2 border border-white/8 inline-block px-3 py-1 rounded-sm">
        ...
        <div className="space-y-3">
          <h2 className="text-sm font-semibold text-white uppercase tracking-wide mb-4">Quick Actions</h2>
